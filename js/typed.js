...
$(function(){
  $(".typed-effect").typed({
    strings: ["", "Coding is Life."], // ^{number} denotes time in ms to wait
  ...
  setTimeout ( function() {
    $(".testing-typed").typed({
    strings: ["Developer ^111, ^333Coder ^111, ^333Designer ^111, ^111Fan of ^333 SPRING ^111 AND ^333Angular .."], // ^{number} denotes time in ms to wait
